...
class accounttype_model extends model {
     ...
     * @param int $actypeid
     */
    function get_one($actypeid = "") {
       if(!empty($actypeid)) {
			$where = "where actypeid=".$actypeid;
     ...
     * return Boolean $flag
     */
    function delete($actypeid) {
        $flag = false;
        $sql = "DELETE FROM ".tname($this->table)." WHERE actypeid=".$actypeid;
