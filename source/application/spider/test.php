...
class application_spider_test {
	...
	*/
    ...
    function stock() {
    	...
    	require_once(ROOT_PATH.'/source/library/phpQuery/phpQuery.php'); 	
    	...
    	echo 'Time: '.(trig_func_common::mtime() - START_TIME);
    }
