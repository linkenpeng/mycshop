...
class page {
    ...
    function next_page($style = '') {
        if ($this->nowindex<$this->totalpage) {return $this->_get_link($this->_get_url($this->nowindex+1),$this->next_page,$style);}
    ...
    function pre_page($style = '') {
        if ($this->nowindex>1) {return $this->_get_link($this->_get_url($this->nowindex-1),$this->pre_page,$style);}
    ...
    function first_page($style = '') {
        if ($this->nowindex==1) {return $this->first_page;}
    ...
    function last_page($style = '') {
        if ($this->nowindex==$this->totalpage) {return $this->last_page;}
