...
*/		var lmcount;
		...
		lm2[3144]=new Array("萝岗区","广州市");
		
		lm2[3145]=new Array("南沙区","广州市");
		
		lm2[3146]=new Array("周边热门区域","广州市");
		
		lm2[3147]=new Array("万江区","东莞市");
		
		lm2[3148]=new Array("东坑镇","东莞市");
		
		lm2[3149]=new Array("东城区","东莞市");
		
		lm2[3150]=new Array("中堂镇","东莞市");
		
		lm2[3151]=new Array("企石镇","东莞市");
		
		lm2[3152]=new Array("凤岗镇","东莞市");
		
		lm2[3153]=new Array("南城区","东莞市");
		
		lm2[3154]=new Array("厚街镇","东莞市");
		
		lm2[3155]=new Array("塘厦镇","东莞市");
		
		lm2[3156]=new Array("大岭山镇","东莞市");
		
		lm2[3157]=new Array("大朗镇","东莞市");
		
		lm2[3158]=new Array("寮步镇","东莞市");
		
		lm2[3159]=new Array("常平镇","东莞市");
		
		lm2[3160]=new Array("望牛墩镇","东莞市");
		
		lm2[3161]=new Array("桥头镇","东莞市");
		
		lm2[3162]=new Array("樟木头镇","东莞市");
		
		lm2[3163]=new Array("横沥镇","东莞市");
		
		lm2[3164]=new Array("沙田镇","东莞市");
		
		lm2[3165]=new Array("洪梅镇","东莞市");
		
		lm2[3166]=new Array("清溪镇","东莞市");
		
		lm2[3167]=new Array("石排镇","东莞市");
		
		lm2[3168]=new Array("石碣镇","东莞市");
		
		lm2[3169]=new Array("石龙镇","东莞市");
		
		lm2[3170]=new Array("茶山镇","东莞市");
		
		lm2[3171]=new Array("莞城区","东莞市");
		
		lm2[3172]=new Array("虎门镇","东莞市");
		
		lm2[3173]=new Array("谢岗镇","东莞市");
		
		lm2[3174]=new Array("道窖镇","东莞市");
		
		lm2[3175]=new Array("长安镇","东莞市");
		
		lm2[3176]=new Array("高埗镇","东莞市");
		
		lm2[3177]=new Array("麻涌镇","东莞市");
		
		lm2[3178]=new Array("黄江镇","东莞市");
		
		lm2[3179]=new Array("篁村区","东莞市");
		
		lm2[3180]=new Array("海陵岛经济开发实验区","阳江市");
		
		lm2[3181]=new Array("石岐区","中山市");
		lm2[3182]=new Array("东区","中山市");
		lm2[3183]=new Array("西区","中山市");
		lm2[3184]=new Array("环城","中山市");
		lm2[3185]=new Array("中山港","中山市");
		lm2[3186]=new Array("五桂山","中山市");
		lm2[3187]=new Array("黄圃镇","中山市");
		lm2[3188]=new Array("南头镇","中山市");
		lm2[3189]=new Array("东凤镇","中山市");
		lm2[3190]=new Array("阜沙镇","中山市");
		lm2[3191]=new Array("小榄镇","中山市");
		lm2[3192]=new Array("东升镇","中山市");
		lm2[3193]=new Array("古镇镇","中山市");
		lm2[3194]=new Array("横栏镇","中山市");
		lm2[3195]=new Array("三角镇","中山市");
		lm2[3196]=new Array("民众镇","中山市");
		lm2[3197]=new Array("南朗镇","中山市");
		lm2[3198]=new Array("港口镇","中山市");
		lm2[3199]=new Array("大涌镇","中山市");
		lm2[3200]=new Array("沙溪镇","中山市");
		lm2[3201]=new Array("三乡镇","中山市");
		lm2[3202]=new Array("板芙镇","中山市");
		lm2[3203]=new Array("神湾镇","中山市");
		lm2[3204]=new Array("坦洲镇","中山市");
		lm2[3205]=new Array("横门镇","中山市");
		lm2[3206]=new Array("沙朗镇","中山市");
		
		lm2[3207]=new Array("南区","中山市");
		
		lm2[3208]=new Array("东海岛经济开发试验区","湛江市");
		
		lm2[3209]=new Array("拱北区","珠海市");
		
		lm2[3210]=new Array("火炬开发区","中山市");
		
		lmcount=345;//全国市的数目
		lmcount2=3211;//全国县的数目
...
// JavaScript Document
		...
		function showprovince(provinceid, cityid, province) {
			var provinces = new Array(
				"北京市", "天津市", "河北省", "山西省", "内蒙古区", "辽宁省", "吉林省", "黑龙江省", "上海市", "江苏省", "浙江省", 
				"安徽省", "福建省", "江西省", "山东省", "河南省", "湖北省", "湖南省", "广东省", "广西区", "海南省", "重庆市", 
				"四川省", "贵州省", "云南省", "西藏区", "陕西省", "甘肃省", "青海省", "宁夏区", "新疆区"
			);

			var html = "<select name=\"" + provinceid + "\" id=\"" + provinceid + "\" onchange=\"changepro('" + cityid  + "', '" + provinceid + "');\">";
		...
		function showcity(cityid, countyid, city, provinceid) {
			if(isUndefined(provinceid)) provinceid = '';
			var html = "&nbsp;<select name=\"" + cityid + "\" id=\"" + cityid + "\" onchange=\"changecity('" + countyid  + "', '" + cityid + "');\">";
			if(provinceid == '') {
				if(city == "") {
			...
			document.write(html);
			if(provinceid != '') {
				changepro(cityid, provinceid);
				initprovcity(cityid, city);
			}
		}

		function showcounty(countyid, cityid, county){
			if(isUndefined(cityid)) cityid = '';
			var html = "&nbsp;<select name=\"" + countyid + "\" id=\"" + countyid + "\">";

			if (cityid == '')
			{
				if(county == "") {
					html = html + "<option value=\"\">选择所在区</option>";
				} else {
			...
			document.write(html);
			if(cityid != '') {
				changecity(countyid, cityid);
				initprovcity(countyid, county);
			}

		}
		function showallzone2(cityid, countyid, city, county){
			
			var cities = new Array(
				"广州市","韶关市","深圳市","珠海市","汕头市","佛山市","江门市","湛江市","茂名市","肇庆市","惠州市","梅州市","汕尾市","河源市",
				"阳江市","清远市","东莞市","中山市","潮州市","揭阳市","云浮市"
			);
			document.getElementById(cityid).options[0] = new Option("选择城市", "选择城市");
			for(var i = 1; i <= cities.length; i++) {
				document.getElementById(cityid).options[i] = new Option(cities[i-1], cities[i-1]);
			}
			initprovcity(cityid, city);
			document.getElementById(countyid).options[0] = new Option("选择所在区", "选择所在区");
			if(cityid != '') {
				changecity(countyid, cityid);
				initprovcity(countyid, county);
			}
		...
		function showallzone(id, provinceid, cityid, countyid, province, city, county){
			...
			provinceselect.name = provinceid;
			provinceselect.id = provinceid;
			provinceselect.onchange = function(){changepro(cityid, provinceid);};

			cityselect.name = cityid;
			cityselect.id = cityid;
			cityselect.onchange = function(){changecity(countyid, cityid);};

			countyselect.name = countyid;
			countyselect.id = countyid;
			...
			provinceselect.options[0] = new Option("选择地区", "");//去掉了后面的选择地区
			for(var i = 1; i <= provinces.length; i++) {
				provinceselect.options[i] = new Option(provinces[i-1], provinces[i-1]);
			}
			id.appendChild(provinceselect);
			id.appendChild(cityselect);
			id.appendChild(countyselect);

			initprovcity(provinceid, province);
			
			document.getElementById(cityid).options[0] = new Option("选择城市", "");//去掉了后面的选择城市
			if(provinceid != '') {
				changepro(cityid, provinceid);
				initprovcity(cityid, city);
			}
			document.getElementById(countyid).options[0] = new Option("选择所在区", "");//去掉了后面的选择所在区
			if(cityid != '') {
				changecity(countyid, cityid);
				initprovcity(countyid, county);
			}
