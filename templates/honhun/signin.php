...
<div class="pageContent">
  <form action="<?php echo get_uri();?>" method="get">
	  ...
	  <tr>
		...
		签到人:<input name="username" type="text" size="12" value="<?=$username?>" />
			签到时间从 
	  ...
	  <table width="100%">
		...
		<tr>
		  ...
		  <td align="center">
				<a href="<?php echo get_uri("signin","delete","admin");?>&signinid=<?=$value['signinid']?>" onclick="return confirm('<?=lang("action","isdelete")?>?');"><?=lang("action","delete")?></a>
		  </td>
		</tr>
		<?php }} ?>
		<tr>
