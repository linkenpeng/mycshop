...
<div class="pageContent">
  <form action="<?php echo get_uri();?>" method="get">
	  ...
	  <tr>
		...
		评论人:<input name="username" type="text" size="12" value="<?=$username?>" />
			评论时间从 
	  ...
	  <table width="100%">
		...
		<tr>
		  ...
		  <?=$value['commented_title']?>
		  </td>  
		  <td align="center"><?php echo $value['username'];?></td>
		  <td align="center"><?php echo date("Y-m-d H:i:s",$value['dateline']);?></td>
		  <td align="center">
				<a href="<?php echo get_uri("comment","delete","admin");?>&commentid=<?=$value['commentid']?>" onclick="return confirm('<?=lang("action","isdelete")?>?');"><?=lang("action","delete")?></a>
		  </td>
		</tr>
		<?php }} ?>
		<tr>
