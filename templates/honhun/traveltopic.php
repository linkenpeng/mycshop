...
<div class="pageContent">
	  ...
	  <table width="100%">
		...
		<tr>
		  ...
		  <?php } ?>
		  <a href="<?php echo get_uri("scene","init","admin");?>&typeid=<?=$value['typeid']?>" ><?=$value['name']?></a>
		  </td>
		  <td><?=$value['description']?></td>
		  <td align="center"><?php echo date("Y-m-d H:i:s",$value['dateline']);?></td>
		  <td align="center">
				<a href="<?php echo get_uri("traveltopic","edit","admin");?>&typeid=<?=$value['typeid']?>" ><?=lang("action","edit")?></a>
				<a href="<?php echo get_uri("traveltopic","delete","admin");?>&typeid=<?=$value['typeid']?>" onclick="return confirm('<?=lang("action","isdelete")?>?');"><?=lang("action","delete")?></a>
		  </td>
		</tr>
		<?php }} ?>
		<tr>
