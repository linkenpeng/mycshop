...
<div class="pageContent">
	  ...
	  <table width="100%">
		...
		<tr>
		  ...
		  <td align="center">
				<a href="<?php echo get_uri("notetype","edit","admin");?>&notetypeid=<?=$value['notetypeid']?>" ><?=lang("action","edit")?></a>
				<a href="<?php echo get_uri("notetype","delete","admin");?>&notetypeid=<?=$value['notetypeid']?>" onclick="return confirm('<?=lang("action","isdelete")?>?');"><?=lang("action","delete")?></a>
		  </td>
		</tr>
		<?php }} ?>
		<tr>
