...
<a href="<?php echo trig_func_common::get_uri("note","add");?>">添加</a>
</div>
  ...
  <form action="<?php echo trig_func_common::get_uri();?>" method="get">
	  ...
	  <table width="100%">
		...
		<tr>
		  ...
		  <td align="center">
				<a href="<?php echo trig_func_common::get_uri("note","edit","admin");?>&noteid=<?php echo $value['noteid']; ?>" ><?php echo trig_func_common::lang("action","edit")?></a>
				<a href="<?php echo trig_func_common::get_uri("note","delete","admin");?>&noteid=<?php echo $value['noteid']; ?>" onclick="return confirm('<?php echo trig_func_common::lang("action","isdelete")?>?');"><?php echo trig_func_common::lang("action","delete")?></a>
		  </td>
		</tr>
		<?php }} ?>
		<tr>
