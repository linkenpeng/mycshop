  ...
  <form action="<?php echo trig_mvc_route::get_uri();?>" method="get">
	  ...
	  <table width="100%">
		...
		<tr>
		  ...
		  <td align="center">
				<a href="<?php echo trig_mvc_route::get_uri("product","edit","admin");?>&productid=<?php echo $value['productid']; ?>" ><?php echo trig_func_common::lang("action","edit")?></a>
				<a href="<?php echo trig_mvc_route::get_uri("product","delete","admin");?>&productid=<?php echo $value['productid']; ?>" onclick="return confirm('<?php echo trig_func_common::lang("action","isdelete")?>?');"><?php echo trig_func_common::lang("action","delete")?></a>
		  </td>
		</tr>
		<?php }} ?>
		<tr>
