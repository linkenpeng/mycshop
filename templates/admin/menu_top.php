...
<div id="top">
	...
	<div id="banner_menu">
		...
		<div>
    		...
    		<li><a href="<?php echo get_uri('index','init');?>">后台首页</a></li>
    		<li><a href="<?php echo get_uri('user','editpass');?>">修改密码</a></li>
    		<li><a href="<?php echo get_uri('login','admin_logout');?>">退出</a></li>
    		</ul>
		</div>
	</div>
</div>