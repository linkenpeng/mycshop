  ...
  <form action="<?php echo get_uri();?>" method="get">
	  ...
	  <table width="100%">
		...
		<tr>
		  ...
		  <td align="center"><?=$notetypes[$value['notetypeid']]?></td>
		  ...
		  <td align="center">
				<a href="<?php echo get_uri("note","edit","admin");?>&noteid=<?=$value['noteid']?>" ><?=lang("action","edit")?></a>
				<a href="<?php echo get_uri("note","delete","admin");?>&noteid=<?=$value['noteid']?>" onclick="return confirm('<?=lang("action","isdelete")?>?');"><?=lang("action","delete")?></a>
		  </td>
		</tr>
		<?php }} ?>
		<tr>
