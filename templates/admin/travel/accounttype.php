...
<div class="pageContent">
	  ...
	  <table width="100%">
		...
		<tr>
		  ...
		  <td align="center">
				<a href="<?php echo trig_mvc_route::get_uri("accounttype","edit","admin", array('actypeid'=>$value['actypeid']));?>" ><?php echo trig_func_common::lang("action","edit")?></a>
				<a href="<?php echo trig_mvc_route::get_uri("accounttype","delete","admin", array('actypeid'=>$value['actypeid']));?>" onclick="return confirm('<?php echo trig_func_common::lang("action","isdelete")?>?');"><?php echo trig_func_common::lang("action","delete")?></a>
		  </td>
		</tr>
		<?php }} ?>
		<tr>
