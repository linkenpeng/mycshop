...
<form action="<?php echo trig_mvc_route::get_uri();?>" method="post" id="dataForm" enctype="multipart/form-data">
  ...
  <table width="100%">
      ...
      <td width="80%">
		<select name="scenespotid" id="scenespotid">
			...
			<?php 	}
				...
				<option value="<?php echo $value['scenespotid']; ?>" selected="selected"><?php echo $value['scenespotname']; ?></option>
			<?php } ?>	
		</select>
	  </td>
    </tr>
	...
	<tr>
      <td width="20%">文物名称</td>
      <td width="80%"><input type="text" name="relicname" id="relicname" value="<?php echo $value['relicname']; ?>" size="50" /> (*)</td>
    </tr>
	<tr>
      <td width="20%">Relic English Name</td>
      <td width="80%"><input type="text" name="relic_enname" id="relic_enname" value="<?php echo $value['relic_enname']; ?>" size="50" /> (*)</td>
    </tr>
	<tr>
      <td width="20%">文物编号</td>
      <td width="80%"><input type="text" name="relicnum" id="relicnum" value="<?php echo $value['relicnum']; ?>" size="50" /></td>
    </tr>
    <tr>
      <td width="20%">文物级别</td>
      <td width="80%">
