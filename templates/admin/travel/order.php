...
<a href="<?php echo trig_func_common::get_uri("order","add");?>">添加</a>
</div>
<div class="pageContent">
	  ...
	  <table width="100%">
		...
		<tr>
		  ...
		  <td align="center">
				<a href="<?php echo trig_func_common::get_uri("order","edit","admin");?>&orderid=<?php echo $value['orderid']; ?>" ><?php echo trig_func_common::lang("action","edit")?></a>
				<a href="<?php echo trig_func_common::get_uri("order","delete","admin");?>&orderid=<?php echo $value['orderid']; ?>" onclick="return confirm('<?php echo trig_func_common::lang("action","isdelete")?>?');"><?php echo trig_func_common::lang("action","delete")?></a>
		  </td>
		</tr>
		<?php }} ?>
		<tr>
