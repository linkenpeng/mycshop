<?php
trig_mvc_template::$title = "用户登录";
trig_mvc_template::$keywords = "用户登录";
trig_mvc_template::$description = "用户登录";
?>
<div class="xs6 xm4 xs3-move xm4-move">
	<br /><br />
	<form action="<?php echo trig_mvc_route::get_uri("login","check_user_login","admin");?>" method="post">
	<div class="panel">
		<div class="panel-head"><strong>登录<?php echo SITE_NAME; ?></strong></div>
